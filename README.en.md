...
- **Gitee Go**: `.workflow/ci.yml` runs the verify-equivalent steps plus bench on Linux / **Node 24.11** after you enable Gitee Go on the repo. Use GitHub Actions for the full cross-platform matrix.
